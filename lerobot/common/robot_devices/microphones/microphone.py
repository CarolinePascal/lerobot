...
class Microphone:
    ...
    def connect(self) -> None:
        ...
        if self.channels is not None and any(c > actual_microphone["max_input_channels"] for c in self.channels):
            raise OSError(
        ...
        self.channels = [c-1 for c in self.channels if c <= actual_microphone["max_input_channels"]]
